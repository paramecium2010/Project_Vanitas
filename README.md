###Project Vanitas「虚空计划」<br>
是由Paramecium制作并推出的EEW音效项目，旨在帮助EEW软件制作人制作音效。<br>
最新一版推出时间：20250716<br>
更新履历：<br>V2.5.1 新增由ずんだもん朗读的特殊包（扩展包）（仅限JMA、CWA版本）<br>
V2.5.0 添加CC许可证，重做海啸音效<br>
V2.4.4 重做海啸音效<br>
...
V1.0.0 震度音效测试版发布<br>
小闲话：作者只有15岁，如果有做得不好的地方勿喷（球球了）<br>
在软件发布时，可以标上这个Project哦（自信）<br>
只是一个小项目（）<br>
由于作者实在不会编程，只能给大佬们做做后勤力（）<br>
有需要定制音效的请私敲~<br>
作者のQQ：3753188053<br>
LISENCE：https://creativecommons.org/licenses/by-nc-nd/4.0/legalcode.en<br>
Tip：使用许可证CC BY-NC-ND 4.0
